...
import com.vmloft.develop.library.tools.picker.loader.IPictureLoader;
...
public class VMPicker {
    ...
    public static final String TAG = VMPicker.class.getSimpleName();
    ...
    private IPictureLoader mPictureLoader;     //图片加载器
    private VMCropView.Style style = VMCropView.Style.RECTANGLE; //裁剪框的形状
    private File cropCacheFolder;
    private File takeImageFile;
    public Bitmap cropBitmap;

    private ArrayList<VMPictureBean> mSelectedImages = new ArrayList<>();   //选中的图片集合
    private List<VMFolderBean> mVMFolderBeans;      //所有的图片文件夹
    ...
    private static VMPicker mInstance;
    ...
    public static VMPicker getInstance() {
        if (mInstance == null) {
            synchronized (VMPicker.class) {
                if (mInstance == null) {
                    mInstance = new VMPicker();
                }
            }
        }
        return mInstance;
    ...
    public ArrayList<VMPictureBean> getCurrentImageFolderItems() {
        return mVMFolderBeans.get(mCurrentImageFolderPosition).images;
    }
    ...
    public void clear() {
        ...
        if (mVMFolderBeans != null) {
            mVMFolderBeans.clear();
            mVMFolderBeans = null;
        }
        if (mSelectedImages != null) {
            mSelectedImages.clear();
