...
public class VMCropView extends AppCompatImageView {
    ...
    public VMCropView(Context context, AttributeSet attrs) {
    ...
    public void saveBitmapToFile(String folder, int expectWidth, int exceptHeight, boolean isSaveRectangle) {
        ...
        final VMPictureBean bean = new VMPictureBean();
    ...
    public interface OnBitmapSaveCompleteListener {
        void onBitmapSaveSuccess(VMPictureBean bean);

        void onBitmapSaveError(VMPictureBean bean);
    }
