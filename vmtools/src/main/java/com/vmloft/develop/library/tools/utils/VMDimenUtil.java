...
public class VMDimenUtil {
    ...
    public static int getNavigationBarHeight(Context appContext) {
        Resources res = appContext.getResources();
        int height = 0;
        if (hasNavigationBar(appContext)) {
    ...
    public static int getSystemBarHeight(Context appContext) {
        Resources res = appContext.getResources();
     ...
     */
    private static boolean hasNavigationBar(Context appContext) {
        boolean hasNavigationBar = false;
        Resources rs = appContext.getResources();
     ...
     * @param id 尺寸资源id
     */
    public static int getDimenPixel(Context appContext, int id) {
        Resources res = appContext.getResources();
     ...
     * @param dp 控件尺寸大小
     */
    public static int dp2px(Context appContext, int dp) {
        Resources res = appContext.getResources();
     ...
     * @param sp 字体的尺寸大小
     */
    public static float sp2px(Context appContext, int sp) {
        Resources res = appContext.getResources();
