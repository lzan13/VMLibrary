package com.vmloft.develop.library.tools.shell.containers;
...
/* #ANNOTATIONS @SupportedAnnotationTypes("com.vmloft.develop.library.tools.shell.containers.RootClass.Candidate") */
