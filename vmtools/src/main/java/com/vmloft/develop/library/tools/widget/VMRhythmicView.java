...
/**
 * Create by lzan13 on 2019/6/7 15:07
 *
 * 自定义展示声音节奏控件，测试状态
 */
public class VMRhythmicView extends View {
    ...
    public VMRhythmicView(Context context) {
        this(context, null);
    }

    public VMRhythmicView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();//初始化
    }
