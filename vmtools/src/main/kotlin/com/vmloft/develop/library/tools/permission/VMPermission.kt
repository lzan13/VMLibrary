...
object VMPermission {
    ...
    private fun startActivity(context: Context) {
        ...
        intent.putExtra(vmPermissionDialogEnableKey, dialogEnable)
        intent.putExtra(vmPermissionDialogTitleKey, dialogTitle)
        intent.putExtra(vmPermissionDialogContentKey, dialogContent)
        intent.putParcelableArrayListExtra(vmPermissionListKey, permissionList as ArrayList<out Parcelable>)
