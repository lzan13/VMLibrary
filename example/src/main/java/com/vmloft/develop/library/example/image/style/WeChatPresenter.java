package com.vmloft.develop.library.example.image.style;
...
public class WeChatPresenter implements IPickerPresenter {
    ...
    public void displayImage(View view, ImageItem item, int size, boolean isThumbnail) {
        ...
        Glide.with(view.getContext()).load(object).apply(new RequestOptions()
                ...
                .into((ImageView) view);
//        Object res = item.getUri() != null ? item.getUri() : item.path;
//        if (isThumbnail) {
//            IMGLoader.INSTANCE.loadThumbnail((ImageView) view, res, true, 4, false);
//        } else {
//            IMGLoader.INSTANCE.loadCover((ImageView) view, res, false, 0, false);
//        }
    }
