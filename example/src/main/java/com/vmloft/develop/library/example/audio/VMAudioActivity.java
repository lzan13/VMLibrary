package com.vmloft.develop.library.example.audio;
...
public class VMAudioActivity extends VMActivity {
    ...
    @OnClick({ R.id.btn_play, R.id.btn_stop_play, R.id.btn_open_speaker, R.id.btn_close_speaker }) void onClick(View view) {
        switch (view.getId()) {
            case R.id.btn_play:
