...
public class CustomViewActivity extends AppActivity {
    ...
    @BindView(R.id.custom_record_view)
    VMRecordView mRecordView;
    @BindView(R.id.custom_square_layout)
    VMSquareLayout mSquareLayout;

    @BindView(R.id.custom_emoji_rain_view)
    VMEmojiRainView mEmojiRainView;
